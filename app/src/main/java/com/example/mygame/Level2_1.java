...
public class Level2_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level1); //текст уровня
        ...
        //анимация н
        final Animation a = AnimationUtils.loadAnimation(Level2_1.this,R.anim.alpha);
        final Animation b = AnimationUtils.loadAnimation(Level2_1.this,R.anim.alpha);
        final Animation c = AnimationUtils.loadAnimation(Level2_1.this,R.anim.alpha);
        final Animation d = AnimationUtils.loadAnimation(Level2_1.this,R.anim.alpha);
        final Animation e = AnimationUtils.loadAnimation(Level2_1.this,R.anim.alpha);
        //анимация к
        ...
        btnclose2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Level2_1.this,GameLevels2.class);
        ...
        //первоначальные значения текста н
            img_l.setText(array.stringbtn2_1[0]);
            img_r.setText(array.stringbtn2_1[1]);
            img_l2.setText(array.stringbtn2_1[2]);
            img_r2.setText(array.stringbtn2_1[3]);
            imgtext.setText(array.stringbtn2_1[4]);
        ...
        //первоначальные значения силы н
            numleft = array.power2_1[0];
            numright = array.power2_1[1];
            numleft2 = array.power2_1[2];
            numright2 = array.power2_1[3];
            numquest = array.power2_1[4];
        o1=0;
        o2=1;
        o3=2;
        o4=3;
        ...
        CountDownTimer my_timer = new CountDownTimer(seconds*1000,1000) {
            ...
            public void onFinish() {
                ...
                if((count==1 || count==2)&&x1==1){
                    ...
                    if(hp!=1) {
                        count = count - 2;
                        img_l.setText(array.stringbtn2_1[o1 - 10]);
                        img_r.setText(array.stringbtn2_1[o2 - 10]);
                        img_l2.setText(array.stringbtn2_1[o3 - 10]);
                        img_r2.setText(array.stringbtn2_1[o4 - 10]);
                        imgtext.setText(array.stringbtn2_1[o5 - 10]);
                        numleft = array.power2_1[o1-10];
                        numright = array.power2_1[o2-10];
                        numleft2 = array.power2_1[o3-10];
                        numright2 = array.power2_1[o4-10];
                        numquest = array.power2_1[o5-10];
                        o1=o1-10;
                        o2=o2-10;
                        o3=o3-10;
                        o4=o4-10;
                ...
                if (event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if (numleft==numquest){
                        if (count<10){
                            ...
                            img_l.setText(array.stringbtn2_1[o1+5]);
                            img_r.setText(array.stringbtn2_1[o2+5]);
                            img_l2.setText(array.stringbtn2_1[o3+5]);
                            img_r2.setText(array.stringbtn2_1[o4+5]);
                            imgtext.setText(array.stringbtn2_1[o5+5]);
                            next();
    ...
    public void next(){
        numleft = array.power2_1[o1+5];
        numright = array.power2_1[o2+5];
        numleft2 = array.power2_1[o3+5];
        numright2 = array.power2_1[o4+5];
        numquest = array.power2_1[o5+5];
        o1=o1+5;
        o2=o2+5;
        o3=o3+5;
        o4=o4+5;
